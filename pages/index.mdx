...
export const LargeText = () => {
  ...
  return (
    <h1
      id='banner-text'
      className={clsx(
        "p-2 font-[1000] text-[min(6rem,15vw)] md:text-[min(6rem,8vw)] bg-gradient-to-r from-25% from-primary to-primary to-75%",
        {
...
<div className="flex gap-x-2 items-center justify-center my-6">
  <Link href='/docs' legacyBehavior>
    <a className="text-lg rounded-lg font-medium px-5 py-3 bg-primary/70 hover:bg-primary transition-colors">Learn More</a>
  </Link>
