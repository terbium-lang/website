...
can be used to specify the absence of a value that *might* exist, *void* is not. This is left up to [optional types](#optional-types).

## Compound Types

Compound types are types that are made up of other types. There are four primitive compound types: tuples,
fixed-size arrays, array slices, and strings.
...
will be covered in the [Optional Types](#optional-types) section, and methods will be covered in the
